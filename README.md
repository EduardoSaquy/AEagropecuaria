...
- **Financeiro** — custo de ração e pasto do dia e do mês, custo por animal, custo diário detalhado por curral, valor total em estoque dos insumos, e cadastro de custos fixos mensais da operação (mão de obra, energia, etc.), com o total mensal (variável + fixo). CRUD completo dos custos fixos.
